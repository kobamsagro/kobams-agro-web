...
export const revalidateExportArticle: CollectionAfterChangeHook<ExportArticle> = ({
  doc,
  req: { payload, context },
}) => {
...
export const revalidateExportArticleDelete: CollectionAfterDeleteHook<ExportArticle> = ({
  doc,
  req: { context, payload },
}) => {
  if (!context.disableRevalidate) {
